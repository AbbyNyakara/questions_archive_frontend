...
const filterQuestionsBySearch = (questions: Question[], searchTerm: string): Question[] => {
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
  const { numSelected, onDownload, currentFilters, totalQuestions, filteredQuestions } = props
...
export default function Questions() {
  ...
  const {
    ...
    queryKey: ['questions', currentFilters.selectedCountry, currentFilters.selectedCategory, currentFilters.selectedRound],
    queryFn: () => fetchQuestions(currentFilters),
    enabled: true,
  })
